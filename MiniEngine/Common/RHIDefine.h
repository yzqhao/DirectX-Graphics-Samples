...
enum ClearFlag
{
	...
	// Discard flag marks the content of attachments don't need to be keeped after rendering. It helps 
	// saving bandwidth: https://developer.huawei.com/consumer/cn/forum/topic/0203339270124340325
	CF_DISCARD_DEPTH = 1 << 7,
	CF_DISCARD_STENCIL = 1 << 8,
	CF_DISCARD_COLOR = 1 << 9,    /**< COLOR0 */
	CF_DISCARD_COLOR1 = 1 << 10,
	CF_DISCARD_COLOR2 = 1 << 11,
	CF_DISCARD_COLOR3 = 1 << 12,
	CF_ENABLE_PLS = 1 << 13,

	CF_DISCARD_COLOR_DEPTH = CF_DISCARD_COLOR | CF_DISCARD_DEPTH,
	CF_DISCARD_COLOR_STENCIL = CF_DISCARD_COLOR | CF_DISCARD_STENCIL,
	CF_DISCARD_DEPTH_STENCIL = CF_DISCARD_DEPTH | CF_DISCARD_STENCIL,
	CF_DISCARD_COLOR123 = CF_DISCARD_COLOR1 | CF_DISCARD_COLOR2 | CF_DISCARD_COLOR3,
	CF_DISCARD_COLOR123_DEPTH_STENCIL = CF_DISCARD_COLOR1 | CF_DISCARD_COLOR2 | CF_DISCARD_COLOR3 | CF_DISCARD_DEPTH | CF_DISCARD_STENCIL,
	CF_DISCARD_COLOR0123_DEPTH_STENCIL = CF_DISCARD_COLOR | CF_DISCARD_COLOR1 | CF_DISCARD_COLOR2 | CF_DISCARD_COLOR3 | CF_DISCARD_DEPTH | CF_DISCARD_STENCIL,
	CF_DISCARD_COLOR013_DEPTH_STENCIL = CF_DISCARD_COLOR | CF_DISCARD_COLOR1 | CF_DISCARD_COLOR3 | CF_DISCARD_DEPTH | CF_DISCARD_STENCIL,
};
